    ...
    public static function gerarRelatorioOS($where)
    {
        ...
        if ($where != "") {
            $result = $database->doSelect(
                ...
                ((IFNULL((SELECT SUM(os_servicos_itens.valor * os_servicos_itens.qntd) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND os_servicos_itens.moeda = 5 AND os_servicos_itens.cancelada = 0 AND os_servicos_itens.Fornecedor_Custeio = 269 GROUP BY os.chave),0)) + IFNULL((SELECT SUM(os_servicos_itens.valor * os_servicos_itens.qntd) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND moeda = 6 AND os_servicos_itens.cancelada = 0 AND os_servicos_itens.Fornecedor_Custeio = 269 GROUP BY os.chave),0) * os.ROE) - IFNULL((SELECT SUM(os_servicos_itens.valor1 * os_servicos_itens.qntd) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND moeda = 5 AND os_servicos_itens.cancelada = 0 AND os_servicos_itens.Fornecedor_Custeio = 269 GROUP BY os.chave),0)) - IFNULL((SELECT SUM(os_servicos_itens.valor1 * os_servicos_itens.qntd) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND moeda = 6 AND os_servicos_itens.cancelada = 0 AND os_servicos_itens.Fornecedor_Custeio = 269 GROUP BY os.chave),0) * os.ROE) as valorLiquidoCoast,
                ((IFNULL((SELECT SUM(os_servicos_itens.valor * os_servicos_itens.qntd) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND os_servicos_itens.moeda = 5 AND os_servicos_itens.cancelada = 0 AND os_servicos_itens.Fornecedor_Custeio = 16 GROUP BY os.chave),0)) + IFNULL((SELECT SUM(os_servicos_itens.valor * os_servicos_itens.qntd) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND moeda = 6 AND os_servicos_itens.cancelada = 0 AND os_servicos_itens.Fornecedor_Custeio = 16 GROUP BY os.chave),0) * os.ROE) - IFNULL((SELECT SUM(os_servicos_itens.valor1 * os_servicos_itens.qntd) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND moeda = 5 AND os_servicos_itens.cancelada = 0 AND os_servicos_itens.Fornecedor_Custeio = 16 GROUP BY os.chave),0)) - IFNULL((SELECT SUM(os_servicos_itens.valor1 * os_servicos_itens.qntd) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND moeda = 6 AND os_servicos_itens.cancelada = 0 AND os_servicos_itens.Fornecedor_Custeio = 16 GROUP BY os.chave),0) * os.ROE) as valorLiquidoStaRig,
                ((IFNULL((SELECT SUM(os_servicos_itens.valor * os_servicos_itens.qntd) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND os_servicos_itens.moeda = 5 AND os_servicos_itens.cancelada = 0 AND os_servicos_itens.Fornecedor_Custeio = 32 GROUP BY os.chave),0)) + IFNULL((SELECT SUM(os_servicos_itens.valor * os_servicos_itens.qntd) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND moeda = 6 AND os_servicos_itens.cancelada = 0 AND os_servicos_itens.Fornecedor_Custeio = 32 GROUP BY os.chave),0) * os.ROE) - IFNULL((SELECT SUM(os_servicos_itens.valor1 * os_servicos_itens.qntd) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND moeda = 5 AND os_servicos_itens.cancelada = 0 AND os_servicos_itens.Fornecedor_Custeio = 32 GROUP BY os.chave),0)) - IFNULL((SELECT SUM(os_servicos_itens.valor1 * os_servicos_itens.qntd) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND moeda = 6 AND os_servicos_itens.cancelada = 0 AND os_servicos_itens.Fornecedor_Custeio = 32 GROUP BY os.chave),0) * os.ROE) as valorLiquidoPortoBrasil,
                ((IFNULL((SELECT SUM(os_servicos_itens.valor * os_servicos_itens.qntd) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND os_servicos_itens.moeda = 5 AND os_servicos_itens.cancelada = 0 AND os_servicos_itens.Fornecedor_Custeio = 17 GROUP BY os.chave),0)) + IFNULL((SELECT SUM(os_servicos_itens.valor * os_servicos_itens.qntd) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND moeda = 6 AND os_servicos_itens.cancelada = 0 AND os_servicos_itens.Fornecedor_Custeio = 17 GROUP BY os.chave),0) * os.ROE) - IFNULL((SELECT SUM(os_servicos_itens.valor1 * os_servicos_itens.qntd) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND moeda = 5 AND os_servicos_itens.cancelada = 0 AND os_servicos_itens.Fornecedor_Custeio = 17 GROUP BY os.chave),0)) - IFNULL((SELECT SUM(os_servicos_itens.valor1 * os_servicos_itens.qntd) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND moeda = 6 AND os_servicos_itens.cancelada = 0 AND os_servicos_itens.Fornecedor_Custeio = 17 GROUP BY os.chave),0) * os.ROE) as valorLiquidoStaSantos,
