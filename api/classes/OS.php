    ...
    public static function gerarRelatorioOS($where)
    {
        ...
        if ($where != "") {
            $result = $database->doSelect(
                ...
                ((IFNULL((SELECT SUM(os_servicos_itens.valor * os_servicos_itens.qntd) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND os_servicos_itens.moeda = 5 AND os_servicos_itens.cancelada = 0 GROUP BY os.chave),0)) + IFNULL((SELECT SUM(os_servicos_itens.valor * os_servicos_itens.qntd) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND moeda = 6 AND os_servicos_itens.cancelada = 0 GROUP BY os.chave),0) * os.ROE) as valor,
                ((IFNULL((SELECT SUM(os_servicos_itens.desconto_valor) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND os_servicos_itens.moeda = 5 AND os_servicos_itens.cancelada = 0 GROUP BY os.chave),0)) + IFNULL((SELECT SUM(os_servicos_itens.desconto_valor) FROM os_servicos_itens WHERE os_servicos_itens.chave_os = os.chave AND moeda = 6 AND os_servicos_itens.cancelada = 0 GROUP BY os.chave),0) * os.ROE) as desconto,
