        ...
        if ($where != "") {
            ...
            INNER JOIN os ON os.chave = contas_aberto.os_origem',
                "
                                          ...
                                          GROUP_CONCAT((SELECT os_servicos_itens.qntd FROM os AS Ordem LEFT JOIN os_servicos_itens ON Ordem.chave = os_servicos_itens.chave_os WHERE Ordem.chave = os.chave ORDER BY os.chave DESC LIMIT 1) SEPARATOR '@.@') AS os_qntd,
