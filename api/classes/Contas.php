        ...
        if ($where != "") {
            ...
            LEFT JOIN os ON os.chave = contas_aberto.os_origem',
                "
                                          ...
                                          GROUP_CONCAT((SELECT GROUP_CONCAT(SUM(os_servicos_itens.valor) SEPARATOR '@.@') FROM os AS Ordem LEFT JOIN os_servicos_itens ON Ordem.chave = os_servicos_itens.chave_os WHERE Ordem.chave = os.chave AND os_servicos_itens.cancelada != 1 AND os_servicos_itens.tipo_sub IN (0,1) AND (os_servicos_itens.repasse = 1 OR os_servicos_itens.Fornecedor_Custeio != '') GROUP BY  os.chave ORDER BY os.chave DESC LIMIT 1) SEPARATOR '@.@') AS evento_valor_new,
