...
if($objData != NULL){
    ...
    //if($result == 'true'){
        //$result = "'" . $id_seaport . "'";
        $result = $os->updateEventoTemplate($chave, $data, $fornecedor, $taxa, $descricao, $ordem, $tipo_sub, $Fornecedor_Custeio, $remarks, $Moeda, $valor, $valor1, $repasse, $gruposNovos, $gruposDeletados, $qntd);
    //}
} else {
    $result = "false";
}
