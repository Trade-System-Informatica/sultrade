...
if($objData != NULL){
    ...
    //if($result == 'true'){
        //$result = "'" . $id_seaport . "'";
        $result = $pessoas->updatePessoa($Chave, $Nome, $Nome_Fantasia, $Cnpj_Cpf, $Rg_Ie, $Inscricao_Municipal, $Nascimento_Abertura, $Inclusao, $Categoria, $Conta_Contabil, $Conta_Provisao, $Conta_Faturar, $Balance, $Indicado);
    //}
} else {
    $result = "false";
}
