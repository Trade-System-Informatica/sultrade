...
class ContasRecebidas extends Component {
    ...
    componentDidMount = async () => {
        ...
        this.state.acessosPermissoes.map((e) => {
            if (e.acessoAcao == "CONTAS_RECEBER" && e.permissaoConsulta == 0) {
                                ...
                                <div className="row mobileajuster3">
                                    ...
                                    <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12  text-right pesquisa mobileajuster1 ">
                                        <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12  text-right pesquisa mobileajuster1 ">
                                            ...
                                            <div>
                                                <Link to={{ pathname: `/admin/relatorio/`, state: {backTo: 'contasRecebidas'} }}><button className="btn btn-success">Relatorio</button></Link>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="single-product-item" >
                                        <div className="row subtitulosTabela">
                                            ...
                                            <div className="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2 text-center">
                                                {!this.state.contas[0] && this.state.acessosPermissoes.filter((e) => { if (e.acessoAcao == 'CONTAS_RECEBER') { return e } }).map((e) => e.permissaoInsere)[0] == 1 &&
                                                    <span className="subtituloships"><Link to={{ pathname: `/admin/addconta/0`, state: { tipo: '0', to: 'contasrecebidas' } }}><FontAwesomeIcon icon={faPlus} /></Link></span>
                                                }
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div ref={feed.Chave == this.state.chaveFocus ? "focusMe" : ""} tabindex={-1} className={`col-lg-8 col-md-8 col-sm-12 mix all dresses bags ${index % 2 == 0 ? feed.Chave == this.state.chaveFocus ? "par focusLight" : "par " : feed.Chave == this.state.chaveFocus ? "impar focusDark" : "impar"}`}>
                                            <div className="row deleteMargin alignCenter">
                                                ...
                                                <div className="col-lg-2 col-md-2 col-sm-2 col-2  text-left  mobileajuster4 icones">
                                                    ...
                                                    {this.state.acessosPermissoes.filter((e) => { if (e.acessoAcao == 'CONTAS_RECEBER') { return e } }).map((e) => e.permissaoDeleta)[0] == 1 &&
