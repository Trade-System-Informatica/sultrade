                                                                        ...
                                                                        {[...Array(5)].map((elemento, elementoIndex) => {
                                                                            return (
                                                                                ...
                                                                                <div className="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-1 text-left">
                                                                                    <Field type="checkbox" className="checkPermissao" disabled={this.state.bloqueado} checked={feed.check[elementoIndex]} onChange={(e) => { this.marcaTodos(e.target.checked, feed.Codigo, elementoIndex, feed.Codigo) }} />
                                                                                </div>
                                                                            )
                                                                        })}
                                                                    </div>
