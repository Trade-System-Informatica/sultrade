...
class AddFatura extends Component {
    ...
    componentDidMount = async () => {
        ...
        this.state.acessosPermissoes.map((e) => {
            if ((e.acessoAcao == "FATURAS" && e.permissaoInsere == 0 && this.state.chave == 0) || (e.acessoAcao == "CONTAS_ABERTAS" && e.permissaoEdita == 0 && this.state.chave != 0)) {
        ...
        return (
            <div className='allContent'>
                ...
                {this.state.finalizaOperacao &&
                    <Redirect to={{ pathname: `/admin/faturas`, state: { chave: this.state.chave } }} />
                }
