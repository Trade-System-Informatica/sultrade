                                ...
                                <div className="rounded">
                                    <ul className='itens_centro'>
                                        <li className=" text-left itemMenu list-group-item ">
                                            <Link className="semTextDecoration" to={{ pathname: `/admin/contasabertas` }}>
                                        ...
                                        <li className=" text-left itemMenu list-group-item ">
                                            <Link className="semTextDecoration" to={{ pathname: `/admin/contasliquidadas` }}>
                                                <FontAwesomeIcon icon={faArchive} size="2x" color="tomato" />
                                                <h4 className="textoMenu">Contas Liquidadas</h4>
                                            </Link>
                                        </li>

                                        {this.state.acessosPermissoes.filter((e) => { if (e.acessoAcao == 'CONTAS_PAGAR') { return e } }).map((e) => e.permissaoConsulta)[0] == 1 &&
                                            <li className=" text-left itemMenu list-group-item ">
                                                <Link className="semTextDecoration" to={{ pathname: `/admin/pagamentoslote` }}>
                                        ...
                                        {this.state.acessosPermissoes.filter((e) => { if (e.acessoAcao == 'CONTAS_PAGAR') { return e } }).map((e) => e.permissaoConsulta)[0] == 1 &&
                                            <li className=" text-left itemMenu list-group-item ">
                                                <Link className="semTextDecoration" to={{ pathname: `/admin/pagamentosmanual` }}>
                                        ...
                                        {/*this.state.acessosPermissoes.filter((e) => { if (e.acessoAcao == 'CONTAS_RECEBER') { return e } }).map((e) => e.permissaoConsulta)[0] == 1 &&
                                            <li className=" text-left itemMenu list-group-item ">
                                                <Link className="semTextDecoration" to={{ pathname: `/admin/recebimentospix` }}>
                                    ...
                                    */}
                                        ...
                                        {this.state.acessosPermissoes.filter((e) => { if (e.acessoAcao == 'FATURAS') { return e } }).map((e) => e.permissaoConsulta)[0] == 1 &&
                                            <li className=" text-left itemMenu list-group-item ">
                                                <Link className="semTextDecoration" to={{ pathname: `/admin/faturas` }}>
