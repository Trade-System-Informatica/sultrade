        ...
        return (
            <div className='allContent'>
                ...
                {this.state.finalizaOperacao &&
                    <Redirect to={{ pathname: '/admin/pessoas', state: { chave: this.state.chave } }} />
                }
                                                            ...
                                                            {window.innerWidth >= 500 &&
                                                                <>
                                                                    ...
                                                                    <div className="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 text-center">
                                                                        ...
                                                                        <Link to=
                                                                            {{
                                                                                pathname: `/admin/addpessoaendereco/${this.props.match.params.id}/0`,
                                                        ...
                                                        {window.innerWidth >= 500 &&
                                                            <div className="row subtitulosTabela">
                                                                ...
                                                                <div className="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2 text-center">
                                                                    <Link to=
                                                                        {{
                                                                            pathname: `/admin/addpessoacontato/${this.props.match.params.id}/0`,
