        ...
        return (
            <div className='allContent'>
                ...
                {this.state.finalizaOperacao && this.props.location.state && this.props.location.state.os &&
                    <Redirect to={{ pathname: `/admin/addos/${this.props.location.state.os.Chave}`, state: { os: this.props.location.state.os } }} />
                }
                {this.state.finalizaOperacao && (!this.props.location.state || !this.props.location.state.os || !this.props.location.state.os.addOS) &&
                    <Redirect to={{ pathname: '/admin/solicitacoesservicos/', state: { chave: this.state.chave } }} />
                }
                {this.state.irParaFinanceiro && this.props.location.state && this.props.location.state.os &&
                    <Redirect to={{ pathname: `/admin/addsolicitacaofinanceiro/${this.state.solicitacao.chave}`, state: { solicitacao: { ...this.state.solicitacao }, os: { ...this.state.os } } }} />
                }
                {this.state.irParaFinanceiro && (!this.props.location.state || !this.props.location.state.os) &&
                    <Redirect to={{ pathname: `/admin/addsolicitacaofinanceiro/${this.state.solicitacao.chave}`, state: { solicitacao: { ...this.state.solicitacao } } }} />
                }
