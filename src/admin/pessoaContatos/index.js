...
import { faSearch, faCoffee, faTrashAlt, faPen, faPlus, faPhoneAlt, faHome } from '@fortawesome/free-solid-svg-icons'
                                    ...
                                    <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12  text-right pesquisa mobileajuster1 ">
                                        ...
                                        {!this.state.contatos[0] &&
                                            <div className="col-7 col-sm-3 col-md-2 col-lg-2 col-xl-2 text-left">
                                                <Link to={{ pathname: `/admin/addpessoacontato/${this.props.location.state.pessoa.Chave}/0`, state: { pessoa: { ...this.props.location.state.pessoa }, backTo: 'contatos' } }}><button className="btn btn-success">Adicionar Contato</button></Link>
                                            </div>}
                                    </div>
                                                ...
                                                <div className="row deleteMargin alignCenter">
                                                    ...
                                                    <div className="col-lg-2 col-md-2 col-sm-2 col-2  text-left icones mobileajuster4 ">
                                                        <div className='iconelixo giveMargin' type='button' >
                                                            <Link to=
                                                                {{
                                                                    pathname: `/admin/addpessoacontato/${feed.Chave_Pessoa}/0`,
                                                        ...
                                                        <div className='iconelixo giveMargin' type='button' >
                                                            <Link to=
                                                                {{
                                                                    pathname: `/admin/addpessoacontato/${feed.Chave_Pessoa}/${feed.Chave}`,
                                                                    state: { contato: { ...feed }, pessoa: { ...this.props.location.state.pessoa }, backTo: 'contatos' }
                                                                }}
                                                            >
