                                ...
                                <div className="row mobileajuster3">
                                    ...
                                    <div className="col-12 text-right pesquisa mobileajuster1 ">
                                        <div className="col-12  text-right pesquisa mobileajuster1 ">
                                            ...
                                            <div>
                                                <Link to={{ pathname: `/admin/relatorio`, state: { backTo: 'contasPagar' } }}><button className="btn btn-success">Relatorio</button></Link>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="row subtitulosTabela">
                                            ...
                                            <div className="col-2 text-center">
                                                {!this.state.contas[0] && this.state.acessosPermissoes.filter((e) => { if (e.acessoAcao == 'CONTAS_PAGAR') { return e } }).map((e) => e.permissaoInsere)[0] == 1 &&
                                                    <span className="subtituloships"><Link to={{ pathname: `/admin/addconta/0`, state: { tipo: 1, to: 'contaspagar' } }}><FontAwesomeIcon icon={faPlus} /></Link></span>
                                                }
                                            </div>
                                        </div>
                                    </div>
