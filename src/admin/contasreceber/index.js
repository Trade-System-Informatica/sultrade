                                ...
                                <div className="row mobileajuster3">
                                    ...
                                    <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12  text-right pesquisa mobileajuster1 ">
                                        <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12  text-right pesquisa mobileajuster1 ">
                                            ...
                                            <div>
                                                <Link to={{ pathname: `/admin/relatorio/`, state: {backTo: 'contasReceber'} }}><button className="btn btn-success">Relatorio</button></Link>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="row subtitulosTabela">
                                            ...
                                            <div className="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2 text-center">
                                                {!this.state.contas[0] && this.state.acessosPermissoes.filter((e) => { if (e.acessoAcao == 'CONTAS_RECEBER') { return e } }).map((e) => e.permissaoInsere)[0] == 1 &&
                                                    <span className="subtituloships"><Link to={{ pathname: `/admin/addconta/0`, state: { tipo: '0', to: 'contasreceber' } }}><FontAwesomeIcon icon={faPlus} /></Link></span>
                                                }
                                            </div>
                                        </div>
                                    </div>
