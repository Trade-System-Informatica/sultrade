        ...
        return (
            <div className='allContent'>
                ...
                {this.state.finalizaOperacao && this.props.location.state.backTo == 'addpessoa' &&
                    <Redirect to={{ pathname: `/admin/addpessoa/${this.props.location.state.pessoa.Chave}`, state: { pessoa: { ...this.props.location.state.pessoa } } }} />
                }
                {this.state.finalizaOperacao && this.props.location.state.backTo == 'enderecos' &&
                    <Redirect to={{ pathname: `/admin/pessoaenderecos/${this.props.location.state.pessoa.Chave}`, state: { pessoa: { ...this.props.location.state.pessoa }, chave: this.state.chave } }} />
                }

                <section>
                    {this.props.location.state.backTo == 'addpessoa' &&
                        <Header voltarAddPessoa pessoa={this.props.location.state.pessoa} titulo="Endereços"/>
                    }
                    {this.props.location.state.backTo == 'enderecos' &&
                        <Header voltarPessoaEnderecos pessoa={this.props.location.state.pessoa} titulo="Endereços" chave={this.state.chave != 0 ? this.state.chave : ''}/>
                    }
                    <br />
                    <br />
                </section>
