        ...
        return (
            <div className='allContent'>
                ...
                {this.state.finalizaOperacao && this.props.location.state.os &&
                    <Redirect to={{ pathname: `/admin/addsolicitacao/${this.state.chave}`, state: { solicitacao: this.state.solicitacao, os: this.props.location.state.os } }} />
                }
                {this.state.finalizaOperacao && !this.props.location.state.os &&
                    <Redirect to={{ pathname: `/admin/addsolicitacao/${this.state.chave}`, state: { solicitacao: this.state.solicitacao } }} />
                }
