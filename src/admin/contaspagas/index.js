...
import { faSearch, faCoffee, faTrashAlt, faPen, faPlus, faEnvelope, faLayerGroup } from '@fortawesome/free-solid-svg-icons'
...
class ContasPagas extends Component {
    ...
    componentDidMount = async () => {
        ...
        this.state.acessosPermissoes.map((e) => {
            if (e.acessoAcao == "CONTAS_PAGAR" && e.permissaoConsulta == 0) {
    ...
    loadAll = async () => {
        await this.setState({
            contas: await loader.getBase('getContasPagas.php', this.state.usuarioLogado.empresa),
            ...
            <div className='allContent'>
                ...
                <div>
                    ...
                    {!this.state.loading &&
                        <div>
                            <section>
                                <Header voltarContasLiquidadas titulo="Contas Pagas"/>
                                ...
                                <div className="row mobileajuster3">
                                    ...
                                    <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12  text-right pesquisa mobileajuster1 ">
                                        <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12  text-right pesquisa mobileajuster1 ">
                                            ...
                                            <div>
                                                <Link to={{ pathname: `/admin/relatorio`, state: {backTo: 'contasPagas'} }}><button className="btn btn-success">Relatorio</button></Link>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="single-product-item" >
                                        <div className="row subtitulosTabela">
                                            ...
                                            <div className="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2 text-center">
                                                {!this.state.contas[0] && this.state.acessosPermissoes.filter((e) => { if (e.acessoAcao == 'CONTAS_PAGAR') { return e } }).map((e) => e.permissaoInsere)[0] == 1 &&
                                                    <span className="subtituloships"><Link to={{ pathname: `/admin/addconta/0`, state: { tipo: 1, to: 'contaspagas' } }}><FontAwesomeIcon icon={faPlus} /></Link></span>
                                                }
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div className="row deleteMargin alignCenter">
                                                ...
                                                <div className="col-lg-2 col-md-2 col-sm-2 col-2  text-left  mobileajuster4 icones">
                                                    <div className='iconelixo giveMargin' type='button' >
                                                        <Link to=
                                                            {{
                                                                pathname: `/admin/addconta/0`,
                                                                state: { conta: {}, tipo: 1, to: 'contaspagas' }
                                                            }}
                                                        >
                                                    ...
                                                    <div className='iconelixo giveMargin' type='button' >
                                                        <Link to=
                                                            {{
                                                                ...
                                                                state: { conta: { ...feed }, to: 'contaspagas' }
                                                            }}
                                                        >
                                                    ...
                                                    {this.state.acessosPermissoes.filter((e) => { if (e.acessoAcao == 'CONTAS_PAGAR') { return e } }).map((e) => e.permissaoDeleta)[0] == 1 &&
...
export default connect(mapStateToProps, null)(ContasPagas)