...
class ContasAbertas extends Component {
                    ...
                    <ul className='itens_centro'>
                        {this.state.acessosPermissoes.filter((e) => { if (e.acessoAcao == 'CONTAS_PAGAR') { return e } }).map((e) => e.permissaoConsulta)[0] == 1 &&
                            <li className=" text-left itemMenu list-group-item ">
                                <Link className="semTextDecoration" to={{ pathname: `/admin/contaspagar` }}>
                                    <FontAwesomeIcon icon={faHandHoldingUsd} size="2x" color="tomato" />
                                    <h4 className="textoMenu">Contas a Pagar</h4>
                                </Link>
                            </li>
                        }
                        ...
                        {this.state.acessosPermissoes.filter((e) => { if (e.acessoAcao == 'CONTAS_RECEBER') { return e } }).map((e) => e.permissaoConsulta)[0] == 1 &&
                            <li className=" text-left itemMenu list-group-item ">
                                <Link className="semTextDecoration" to={{ pathname: `/admin/contasreceber` }}>
                                    <FontAwesomeIcon icon={faCashRegister} size="2x" color="tomato" />
                                    <h4 className="textoMenu">Contas a Receber</h4>
                                </Link>
                            </li>
                        }
...
export default connect(mapStateToProps, null)(ContasAbertas)