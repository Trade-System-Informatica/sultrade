...
class AddSolicitacaoFinanceiro extends Component {
    ...
    componentDidMount = async () => {
        ...
        if (parseInt(id) != 0) {
            await this.loadAll()
            await this.setState({
                moeda: this.state.solicitacao.Moeda,
                valor: new Intl.NumberFormat('pt-BR', { style: 'decimal', minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(this.state.solicitacao.valor),
                vlrc: new Intl.NumberFormat('pt-BR', { style: 'decimal', minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(this.state.solicitacao.valor1),
                repasse: this.state.solicitacao.repasse == 1 ? true : false,
                emissao: moment(this.state.solicitacao.emissao).format('YYYY-MM-DD'),
                vencimento: moment(this.state.solicitacao.vencimento).format('YYYY-MM-DD'),
                desconto: new Intl.NumberFormat('pt-BR', { style: 'decimal', minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(this.state.solicitacao.desconto_valor),
                descontoComplemento: this.state.solicitacao.desconto_cpl,
                descontoConta: this.state.solicitacao.desconto_conta,
                retencaoInss: new Intl.NumberFormat('pt-BR', { style: 'decimal', minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(this.state.solicitacao.retencao_inss_valor),
                retencaoInssComplemento: this.state.solicitacao.retencao_inss_cpl,
                retencaoInssConta: this.state.solicitacao.retencao_inss_conta,
                retencaoIr: new Intl.NumberFormat('pt-BR', { style: 'decimal', minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(this.state.solicitacao.retencao_ir_valor),
                retencaoIrComplemento: this.state.solicitacao.retencao_ir_cpl,
                retencaoIrConta: this.state.solicitacao.retencao_ir_conta,
                retencaoIss: new Intl.NumberFormat('pt-BR', { style: 'decimal', minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(this.state.solicitacao.retencao_iss_valor),
                retencaoIssComplemento: this.state.solicitacao.retencao_iss_cpl,
                retencaoIssConta: this.state.solicitacao.retencao_iss_conta,
                retencaoPis: new Intl.NumberFormat('pt-BR', { style: 'decimal', minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(this.state.solicitacao.retencao_pis_valor),
                retencaoPisComplemento: this.state.solicitacao.retencao_pis_cpl,
                retencaoPisConta: this.state.solicitacao.retencao_pis_conta,
                retencaoCofins: new Intl.NumberFormat('pt-BR', { style: 'decimal', minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(this.state.solicitacao.retencao_cofins_valor),
                retencaoCofinsComplemento: this.state.solicitacao.retencao_cofins_cpl,
                retencaoCofinsConta: this.state.solicitacao.retencao_cofins_conta,
                retencaoCsll: new Intl.NumberFormat('pt-BR', { style: 'decimal', minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(this.state.solicitacao.retencao_csll_valor),
                retencaoCsllComplemento: this.state.solicitacao.retencao_csll_cpl,
                retencaoCsllConta: this.state.solicitacao.retencao_csll_conta,
                complemento: this.state.solicitacao.complemento,
                contaContabil: this.state.solicitacao.contaContabil,

                navio: this.state.solicitacao.navioNome,
                fornecedorNome: this.state.solicitacao.fornecedorNome,
            ...
            await this.setState({
                retencaoInssCheck: this.state.solicitacao.retencao_inss_conta && this.state.solicitacao.retencao_inss_conta != '0',
                retencaoIrCheck: this.state.solicitacao.retencao_ir_conta && this.state.solicitacao.retencao_ir_conta != '0',
                retencaoIssCheck: this.state.solicitacao.retencao_iss_conta && this.state.solicitacao.retencao_iss_conta != '0',
                retencaoPisCheck: this.state.solicitacao.retencao_pis_conta && this.state.solicitacao.retencao_pis_conta != '0',
                retencaoCofinsCheck: this.state.solicitacao.retencao_cofins_conta && this.state.solicitacao.retencao_cofins_conta != '0',
                retencaoCsllCheck: this.state.solicitacao.retencao_csll_conta && this.state.solicitacao.retencao_csll_conta != '0',
            })
    ...
    loadAll = async () => {
        await this.setState({
            solicitacao: await loader.getOne('getSolicitacao.php', this.state.chave),
    ...
    salvarConta = async (validFormContabiliza) => {
        this.setState({ bloqueadoContabiliza: true });

        if (validFormContabiliza) {
            await apiEmployee.post(`insertContaFornecedor.php`, {
                token: true,
                values: `'${this.state.emissao}', '${this.state.tipo}', '${this.state.solicitacao.fornecedor}', '${this.state.solicitacao.contaContabil}', '${this.state.codBarras}', '${this.state.solicitacao.centroCusto}', '${`VLR REF A DOC ${this.state.documento} ${this.state.fornecedorNome} ST ${this.state.solicitacao.centroCusto} NAVIO ${this.state.navio}`}',  '${this.state.contaDesconto}','${1}', '${1}', '${parseFloat(this.state.vlrc.replaceAll('.', '').replaceAll(',', '.'))}', '${this.state.vencimento}', '${this.state.vencimento}', '${this.state.contaProvisao}', '${parseFloat(this.state.vlrc.replaceAll('.', '').replaceAll(',', '.'))}', '${this.state.usuarioLogado.codigo}', '${this.state.empresa}', '${this.state.documento}', '${this.state.tipoDocumento}', '${this.state.meioPagamento}', '${this.state.chave}'`,
    ...
    getOSUma = async () => {
        await apiEmployee.post(`getOSUma.php`, {
            token: true,
            chave_os: this.state.solicitacao.chave_os
        }).then(
            async res => {
    ...
    trocarTipoContabilizar = async (value) => {
        ...
        if (this.state.solicitacao.tipo_sub == 2) {
            if (this.state.tipo == '0') {
                this.setState({ contaDesconto: await loader.getContaTaxa(this.state.solicitacao.taxa) })
            ...
            if (this.state.repasse) {
                if (this.state.tipo == '0') {
                    this.setState({ contaDesconto: await loader.getContaPessoa(this.state.solicitacao.fornecedor) })
                } else if (this.state.tipo == 1) {
                    this.setState({ contaDesconto: await loader.getContaPessoa(this.state.os.Chave_Cliente) })
                }
            } else {
    ...
    render() {
        ...
        return (
            <div className='allContent'>
                ...
                {this.state.finalizaOperacao && this.props.location.state.os &&
                    <Redirect to={{ pathname: `/ordensservico/addsolicitacao/${this.state.chave}`, state: { solicitacao: this.state.solicitacao, os: this.props.location.state.os } }} />
                }
                {this.state.finalizaOperacao && !this.props.location.state.os &&
                    <Redirect to={{ pathname: `/ordensservico/addsolicitacao/${this.state.chave}`, state: { solicitacao: this.state.solicitacao } }} />
                }
                    ...
                    <>
                        <section>
                            {this.props.location.state.os &&
                                <Header voltarAddSolicitacao solicitacao={this.state.solicitacao} os={this.props.location.state.os} titulo="Solicitações de Serviço" />
                            }
                            {!this.props.location.state.os &&
                                <Header voltarAddSolicitacao solicitacao={this.state.solicitacao} titulo="Solicitações de Serviço" />
                            }
                                ...
                                <div className='modalCriar'>
                                    ...
                                    <div className='modalContent'>
                                        <div className='tituloModal'>
                                            <span>Informações para conta em aberto:</span>
                                        </div>
                                                        ...
                                                        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                            ...
                                                            <div className="row addservicos">
                                                                ...
                                                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-10 col-10">
                                                                    <select value={this.state.tipo} onChange={async (e) => { await this.trocarTipoContabilizar(e.currentTarget.value) }} className='form-control'>
                                                                ...
                                                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-10 col-10">
                                                                    <input className='form_control' checked={this.state.provisaoCheck} onChange={async (e) => { await this.setState({ provisaoCheck: e.target.checked }); if (this.state.provisaoCheck) { await this.setState({ contaProvisao: await loader.getContaPessoa(this.state.solicitacao.fornecedor, 'provisao') }) } else { await this.setState({ contaProvisao: '' }) } }} type="checkbox" />
                                                                </div>
                                                                ...
                                                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-10 col-10">
                                                                    <Select className='SearchSelect'
                                                                        isDisabled={!(this.state.solicitacao.tipo_sub != 2 && !this.state.repasse && this.state.tipo == 1)}
                                    ...
                                    >
                                        <Form className="contact-form" >
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 ">
                                                    ...
                                                    <div className="row addservicos">
                                                        ...
                                                        <div className="fieldDividido col-xl-6 col-lg-6 col-md-6 col-sm-10 col-10">
                                                            ...
                                                            <Field disabled={this.state.repasse} className="form-control fieldDividido_2 text-right " type="text" onClick={(e) => e.target.select()} value={this.state.valor} onChange={async e => { if (!this.state.repasse) { this.setState({ valor: e.currentTarget.value }) } }} onBlur={async e => { this.setState({ valor: Number(e.currentTarget.value.replaceAll('.', '').replaceAll(',', '.')) ? new Intl.NumberFormat('pt-BR').format(e.currentTarget.value.replaceAll('.', '').replaceAll(',', '.')) : '' }) }} />
                                                        </div>
                                                        <div className="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12 labelForm">
                                                            <label>VCP</label>
                                                        </div>
                                                        ...
                                                        <div className='col-1'></div>
                                                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-10 col-10">
                                                            <input className='form_control' checked={this.state.repasse} onChange={(e) => { this.setState({ repasse: e.target.checked, pessoa: '', tipo: '', contaDesconto: '' }) }} type="checkbox" />
                                                        </div>
                                                        <div className='col-1'></div>
                                                        <div className="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12 labelForm">
                                                            <label>Emissão</label>
                                                ...
                                                <div className="row">
                                                    {!this.state.conta && this.state.solicitacao.centroCusto != '0' && this.state.contaContabil != '0' &&
                                                        <>
                                                    ...
                                                    {(this.state.conta || this.state.solicitacao.centroCusto == '0' || this.state.contaContabil == '0') &&
                                                        <>
                                                            ...
                                                            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                                                <button
                                                                    title={this.state.conta ? "Esta solicitação já foi contabilizada" : this.state.solicitacao.centroCusto == '0' ? "Nenhum centro de custo vinculado" : "Nenhuma conta contabil vinculada"}
                                                                    disabled
...
export default connect(mapStateToProps, null)(AddSolicitacaoFinanceiro)
