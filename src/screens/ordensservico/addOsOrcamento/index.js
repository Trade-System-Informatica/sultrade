...
class AddOsOrcamento extends Component {
  ...
  getOS = async () => {
    ...
    console.log(this.state.ordem_servico_codigos);
  };
            ...
            <div style={{ width: "80%", marginLeft: "5%" }}>
              <table>
                ...
                <tr>
                  ...
                  <td colSpan={2} className="pdf_total_col">
                    <b>PO:</b>{" "}
                    {util.returnIfExists(
                      this.state.pdfContent[0],
                  ...
                  {vouchers.map((voucher, index) => {
                    ...
                    return (
                      <>
                        ...
                        <tr>
                          <td
                            className="pdf_small_col reduce-font"
                          ...
                          <td
                            className="pdf_money_colOS reduce-font"
                            style={{ backgroundColor: backgroundColor }}
                          >
...
*/}
        ...
        pdfCusteio.map((custeio, custeioIndex) => {
          ...
          if (custeio) {
            ...
            if (!["17", "16"].includes(pdfCusteioCodigo[custeioIndex])) {
              ...
              pdfContent
                .filter((content) => !!content.fornecedor_custeio)
                .map((content, index) => {
                  let valor_cobrar = content.valor_cobrar;
                  let valor_pago = content.valor_pago;
            ...
            <div>
              <table style={{ width: "90%", marginLeft: "5%" }}>
                ...
                {this.state.pdfContent[0].governmentTaxes > 0 && (
                  <tr>
                    <td colSpan="7" className="pdf_large_col reduce-font">
  ...
  gerarOrcamento = async (codigo, validForm) => {
    try {
      ...
      this.setState({
        pdfNome: `PROFORMA INVOICE${
          this.state.pdfContent[0]?.dataEmissao &&
          this.state.pdfContent[0]?.sequencialOrcamento
            ? ` - ${this.state.pdfContent[0]?.dataEmissao}${this.state.pdfContent[0]?.sequencialOrcamento}`
            : ""
        }`,
      });
            ...
            <div className="pdfContent">
              <div>
                <table className="pdfTableCabecalho">
                  ...
                  <tr>
                    ...
                    {this.state.pdfContent[0].data_chegada &&
                      moment(
                        ...
                        <td className="pdf_total_col" colSpan="2">
                          <b style={{ paddingRight: 5 }}>ETA:</b>{" "}
                          {moment(
                            util.returnIfExists(
                              this.state.pdfContent[0],
                              this.state.pdfContent[0].data_chegada
                  ...
                  <tr>
                    <td className="pdf_small_col" colSpan="4">
                      <b style={{ paddingRight: 5 }}>Port:</b>{" "}
                      {util.returnIfExists(
                        this.state.pdfContent[0],
                        this.state.pdfContent[0].nomePorto
                      )}
                    </td>
                    {this.state.pdfContent[0].etb &&
                      moment(this.state.pdfContent[0].etb).isValid() && (
                        <td className="pdf_total_col" colSpan="2">
                          <b style={{ paddingRight: 5 }}>ETB:</b>{" "}
                          {moment(
                            util.returnIfExists(
                              this.state.pdfContent[0],
                              this.state.pdfContent[0].etb
                  ...
                  <tr>
                    {/*
                                        ...
                                        <td className="pdf_money_colOS" colSpan='2'><b style={{ paddingRight: 5 }}>O.C.C:</b> {util.returnIfExists(this.state.pdfContent[0], this.state.pdfContent[0].centro_custo)}</td>
                                    */}
                  </tr>
                  <tr>
                    <td className="pdf_small_col" colSpan="4">
            ...
            <div>
              <table style={{ width: "90%", marginLeft: "5%" }}>
                ...
                <tr>
                  <td
                    colSpan="7"
                    className="pdf_padding"
                    style={{ backgroundColor: "#CDCDCD" }}
                  >
                    DESCRIPTION:
                  </td>
                  <td
                    className="pdf_money_header reduce-font"
                    style={{ backgroundColor: "#CDCDCD", width: "10%", fontSize: '13px'}}
                  >
                    VALUE(USD)
                  </td>
                  <td
                    className="pdf_money_header reduce-font"
                    style={{ width: "10%", backgroundColor: "#CDCDCD", fontSize: '13px' }}
                  >
                    VALUE(R$)
                  </td>
                  <td
                    className="pdf_qntd_col reduce-font"
                    style={{ width: "5%", backgroundColor: "#CDCDCD", fontSize: '13px' }}
                  >
                    QTY
                  </td>
                  <td
                  ...
                  if (e.tipo == 0 || e.tipo == 1) {
                    return (
                      ...
                      >
                        <td
                          colSpan="7"
                          className="pdf_padding reduce-font"
                          style={{
                            background: backgroundColor,
                            color: textColor,
                          }}
                        ...
                        <td
                          className="pdf_money_col reduce-font"
                          style={{
                            background: backgroundColor,
                            color: textColor,
                          }}
                ...
                {/* {this.state.pdfContent[0].governmentTaxes > 0 && (
                  <tr>
                    ...
                    <td className="pdf_total_col reduce-font">
                      <b>
                        {util.formataDinheiroBrasileiro(
                          parseFloat(
                            this.state.pdfContent[0].governmentTaxes /
  ...
  InserirEmOs = async (reload = false) => {
    await apiEmployee
      .post(`insertEventosOrcamentoToOs.php`, {
        token: true,
        chave_os: this.state.os_escolhida.value,
        chave_orcamento: this.state.chave,
        canceladaPor: this.state.usuarioLogado.codigo,
      })
      .then(
        async (res) => {
  ...
  criarOs = async (reload = false) => {
    await apiEmployee
      .post(`transformaOrcamentoEmOs.php`, {
        token: true,
        Chave: this.state.chave,
      })
      .then(
        ...
        {!this.state.loading && (
          <>
            ...
            <Modal
              ...
              open={this.state.modalEscolhaOs}
              onClose={async () =>
                await this.setState({ modalEscolhaOs: false })
              }
            >
              <div className="modalContainer">
                <div className="modalCriar">
              ...
              <div className="row">
                ...
                {this.props.match.params.id != 0 && (
                  <>
                    ...
                    <br />
                    <div className="relatoriosSection">
                      <div className="relatorioButton"></div>
                      <div className="relatorioButton">
                        <button
                          className="btn btn-danger"
                          onClick={() => this.deleteOrcamento(this.state.chave)}
                        >
                          Cancelar orçamento
                        </button>
                      </div>
                      <div className="relatorioButton">
                        <button
                          ...
                          onClick={() =>
                            this.gerarOrcamento(this.state.codigo, validForm)
                          }
                        >
                          Gerar Orçamento
                        </button>
                      ...
                      <div className="relatorioButton">
                        <button
                          ...
                          onClick={() => {
                            this.setState({ modalEscolhaOs: true });
                          }}
                        >
                          Inserir em OS existente
                        </button>
                      </div>
                      <div className="relatorioButton">
                        <button
