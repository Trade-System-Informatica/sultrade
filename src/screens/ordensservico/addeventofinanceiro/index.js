    ...
    salvarConta = async (validFormContabiliza) => {
        ...
        if (validFormContabiliza) {
            await apiEmployee.post(`insertContaFornecedor.php`, {
                token: true,
                values: `'${this.state.emissao}', '${this.state.tipo}', '${this.state.evento.fornecedor}', '${this.state.tipo == 0 ? this.state.contaCredito : this.state.contaDesconto}', '${this.state.codBarras}', '${this.state.evento.centroCusto}', '${this.state.historico}',  '${this.state.tipo == 0 ? this.state.contaDesconto : this.state.contaCredito}','${1}', '${1}', '${parseFloat(valorFinal)}', '${this.state.vencimento}', '${this.state.vencimento}', '${this.state.contaProvisao}', '${valorFinal}', '${this.state.usuarioLogado.codigo}', '${this.state.empresa}', '${this.state.documento}', '${this.state.tipoDocumento}', '${this.state.meioPagamento}', '${this.state.chave}'`,
