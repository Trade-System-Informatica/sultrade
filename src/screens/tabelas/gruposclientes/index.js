...
class GruposClientes extends Component {
    ...
    componentDidMount = async () => {
        ...
        if (this.state.chaveFocus) {
            ...
            if (e.acessoAcao == "GRUPOS_CLIENTES" && e.permissaoConsulta == 0) {
                                    ...
                                    await apiEmployee.post(`deleteGrupo.php`, {
                                        ...
                                        async response => {
                                            if (response.data == true) {
                                                await loader.salvaLogs('os_grupos_clientes', this.state.usuarioLogado.codigo, null, "Exclusão", id);
        ...
        return (
            ...
            <div className='allContent'>
                ...
                <div>
                    ...
                    {!this.state.loading &&
                        <div>                            <section>
                                <Header voltarTabelas grupos titulo="Grupos de Clientes"/>
                                                ...
                                                <div className="row deleteMargin alignCenter">
                                                    ...
                                                    <div className="col-lg-1 col-md-1 col-sm-1 col-1  text-left  mobileajuster4 icones">
                                                        <div className='iconelixo giveMargin' type='button' >
                                                            <Link to=
                                                                {{
                                                                    pathname: `/tabelas/addgrupocliente/0`,
                                                                    state: { grupo: { ...feed } }
                                                                }}
                                                            >
                                                        ...
                                                        <div className='iconelixo giveMargin' type='button' >
                                                            <Link to=
                                                                {{
                                                                    pathname: `/tabelas/addgrupocliente/${feed.chave}`,
                                                                    state: { grupo: { ...feed } }
                                                                }}
                                                            >
                                                        ...
                                                        {this.state.acessosPermissoes.filter((e) => { if (e.acessoAcao == 'GRUPOS_CLIENTES') { return e } }).map((e) => e.permissaoDeleta)[0] == 1 &&
                                            ...
                                            {window.innerWidth < 500 &&
                                                ...
                                                onClick={() => {
                                                    this.setState({
                                                        ...
                                                        itemInfo: [
                                                            { titulo: 'Codigo', valor: feed.chave },
                                                            { titulo: 'Grupo', valor: feed.descricao },
                                                        ],
                                                        itemPermissao: 'GRUPOS_CLIENTES',
...
export default connect(mapStateToProps, null)(GruposClientes)