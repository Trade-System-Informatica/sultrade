...
class AddHistorico extends Component {
    ...
    componentDidMount = async () => {
        ...
        if (parseInt(id) !== 0) {
            await this.setState({ historico: this.props.location.state.historico })
    ...
    salvarHistorico = async (validForm) => {
        ...
        if (parseInt(this.state.chave) === 0 && validForm) {
            ...
            await apiEmployee.post(`insertHistorico.php`, {
                token: true,
            ...
            await apiEmployee.post(`updateHistorico.php`, {
                token: true,
    ...
    openLogs = async () => {
        await this.setState({ logs: await loader.getLogs("historicos", this.state.chave) })
        ...
        return (
            <div className='allContent'>
                ...
                {this.state.finalizaOperacao &&
                    <Redirect to={{pathname: '/tabelas/historicospadrao', state:{chave: this.state.chave}}} />
                }

                <section>
                    <Header voltarHistoricosPadrao titulo="Históricos Padrão" chave={this.state.chave != 0 ? this.state.chave : ''}/>
                </section>
                        ...
                        <div className="col-lg-12">
                            <Formik
                                ...
                                onSubmit={async values => {
                                    ...
                                    this.salvarHistorico(validForm)
                                }}
                            >
...
export default connect(mapStateToProps, null)(AddHistorico)
