            ...
            if (parseInt(this.state.chave) === 0) {
                if (this.state.tipo == 0) {
                    await apiEmployee.post(`insertContaCliente.php`, {
                        ...
                        dadosManuais: this.state.manual ? `'${this.state.os}', '${this.state.navio}', '${this.state.porto}', '${this.state.roe.replaceAll(',', '.')}', '${parseFloat(this.state.discount.replaceAll('.', '').replaceAll(',', '.'))}', '${parseFloat(this.state.received.replaceAll('.', '').replaceAll(',', '.'))}', ${moment(this.state.sailed).isValid() ? moment(this.state.sailed).format("YYYY-MM-DD") : ''}` : ""
                    }).then(
                        async res => {
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-12 ">
                                                    ...
                                                    <div className="row addservicos">
                                                        ...
                                                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-10 col-10">
                                                            {(isNaN(parseFloat(this.state.saldo)) || parseFloat(this.state.saldo.replace(",", ".")) > 0) &&
